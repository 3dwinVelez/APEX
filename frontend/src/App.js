              ...
              <Card key={t.tipo} onClick={() => seleccionarTipo(t)}
                ...
                {!t.img && (
                  <div style={{ height:120, background:C.bg, display:"flex", alignItems:"center", justifyContent:"center" }}>
                    <span style={{ fontSize:40 }}>[camion]</span>
                  </div>
                )}
          ...
          {tipoSel && (
            <Card style={{ marginBottom:16, padding:0, overflow:"hidden", borderTop:`4px solid ${tipoSel.color_cat || C.accent}` }}>
              <div style={{ display:"flex", alignItems:"center", gap:0 }}>
                <div style={{ width:100, flexShrink:0, background: tipoSel.color_cat+"20" || C.bg,
                  display:"flex", flexDirection:"column", alignItems:"center", justifyContent:"center", padding:16, minHeight:100 }}>
                  <div style={{ fontSize:32, fontWeight:900, color: tipoSel.color_cat || C.accent }}>{tipoSel.ejes || "?"}</div>
                  <div style={{ fontSize:9, color:C.muted, fontWeight:700 }}>EJES</div>
                  <div style={{ fontSize:11, fontWeight:800, color: tipoSel.color_cat || C.accent, marginTop:4, textAlign:"center" }}>{tipoSel.codigo}</div>
                </div>
