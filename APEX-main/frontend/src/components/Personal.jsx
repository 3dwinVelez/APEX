...
const Personal = ({ onBack, user }) => {
  ...
  const guardar = async () => {
    if (isReadOnlyForm) { setToast({ msg: "No tienes permisos para modificar personal", type: "error" }); return; }
    ...
    <div>
      ...
      <div style={{ maxWidth: 480 }}>
        {[
          ...
          <Card key={r.rol} onClick={canCreatePersonal ? () => { setRolSel(r.rol); setVista("form"); } : null}
  ...
  return (
    <div>
      ...
      <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: 20 }}>
        ...
        <Btn onClick={() => setVista("roles")} disabled={!canCreatePersonal} title={!canCreatePersonal ? "Este perfil no puede crear usuarios" : ""}>+ NUEVO USUARIO</Btn>
      </div>
